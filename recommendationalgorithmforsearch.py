...
def recommend_recipes(df,interaction_df,healthLabels,dietLabels,min_recommendations=23, max_recommendations=300):
...
# Check if 'view_duration' column exists, add it with default 0 values if not
    ...
    recommendations = []
    names = []
    threshold = 0.825  # Initial threshold
...
def generate_and_store_recommendations():
    ...
    if all_recommendations:
        ...
        with open('user_recommendations_for_search.json', 'w') as json_file:
